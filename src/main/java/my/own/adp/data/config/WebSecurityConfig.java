package my.own.adp.data.config;
...
import my.own.adp.data.config.properties.WebConfigProperties;
...
public class WebSecurityConfig extends KeycloakWebSecurityConfigurerAdapter {
    private static final String ALLOW_ACCESS_TO_ALL_ENDPOINTS = "/**";

    private final WebConfigProperties.Cors cors;
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        source.registerCorsConfiguration(ALLOW_ACCESS_TO_ALL_ENDPOINTS, configuration);
        return source;
    }
